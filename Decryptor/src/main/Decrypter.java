...
public class Decrypter {
	...
	private static Key decryptAESKey(byte[] AESKey, Key RSAKey) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException {
	...
	public boolean ProcessFile(String path) {
		try {
			...
			String outPath = path.replace(".InstaCrypt", "");
